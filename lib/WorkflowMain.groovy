//
// This file holds several functions specific to the main.nf workflow in the Arcadia-Science/hifi2genome pipeline
//
...
class WorkflowMain {
    ...
    public static void initialize(workflow, params, log) {
        ...
        if if (workflow.profile.tokenize(',').intersect(['conda', 'mamba']).size() >= 1) {
