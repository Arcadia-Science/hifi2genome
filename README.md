...
> **This workflow is now archived and not currently maintained. The [reads2genome workflow](https://github.com/Arcadia-Science/reads2genome) is now the actively maintained assembly workflow for Arcadia Science that can assemble and QC Illumina, Nanopore, or Pacbio HiFi reads.**

![](img/hifi2genome_overview_figure.jpg)
